...
import { Radar, ArrowRight, Lock, Mail, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      } else if (err === "google_auth_failed" || err === "google_user_failed") {
        setError("Google authentication failed. Please try again.");
      } else if (notice === "account_deleted") {
        setNoticeMessage("Your account and all personal data have been permanently wiped.");
      } else if (notice === "google_setup_required") {
        setNoticeMessage("Official Google OAuth requires GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in .env. Please sign in with your Email and Password below, or add your Google Cloud keys.");
      }
    }
  }, []);
