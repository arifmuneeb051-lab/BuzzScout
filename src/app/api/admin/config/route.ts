  ...
  try {
    ...
    const updated = await prisma.siteConfig.upsert({
      ...
      create: {
        ...
        announcementText: announcementText || "Disrupting Traditional Monitors — Claim $25 Lifetime Access Now",
        ...
        trialDays: 0,
        monthlyPrice: Number(monthlyPrice) || 5,
        ltdPrice: Number(ltdPrice) || 25,
