...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState("admin@signalpulse.io");
    ...
    <div className="min-h-screen bg-[#06080e] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p className="mt-2 text-xs sm:text-sm text-slate-400">
          Company Master Control & Database Management Center
        </p>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4 sm:px-0">
        <div className="bg-[#0b0f19]/90 border border-white/10 backdrop-blur-2xl py-8 px-6 sm:px-10 shadow-2xl rounded-3xl space-y-6">
          {error && (
          ...
          <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs space-y-1">
            ...
            <p className="font-mono text-[11px] text-slate-300">
              Email: <span className="text-amber-200">admin@signalpulse.io</span><br />
              Password: <span className="text-amber-200">Admin@2026!</span>
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@signalpulse.io"
